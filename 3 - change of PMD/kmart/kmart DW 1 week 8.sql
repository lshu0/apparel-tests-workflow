...
from	(select	pa13.WK_NBR  WK_NBR,
	...
	from	(select	a11.WK_NBR  WK_NBR,
		...
		where	(a12.KSN_ID in (sel ksn from shc_work_tbls.kmart_all_items where wk_no =8 and test_nm = 'D&W 1')
		 and a11.WK_NBR in (201608)
		 and a11.LOCN_NBR in (sel locn from shc_work_tbls.kmart_all_stores where wk_no=8 and test_nm = 'D&W 1')
	...
	where	s21.KSN_ID in (sel ksn from shc_work_tbls.kmart_all_items where wk_no =8 and test_nm = 'D&W 1')
